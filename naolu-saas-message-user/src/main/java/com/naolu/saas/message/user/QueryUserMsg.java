...
import com.naolu.saas.message.base.QueryBaseMsg;
import com.naolu.saas.message.base.StatusMsg;
import com.naolu.saas.message.base.UserIdMsg;

public class QueryUserMsg extends QueryBaseMsg{
	...
	public QueryUserMsg(String herUserId, String phone, String name, Integer gender, Integer age) {
		super();
		this.herUserId = herUserId;
		this.phone = phone;
		this.name = name;
