...
public class RoleMsg extends CommonMsg{
	...
	public RoleMsg(OwnerIdMsg ownerId, StatusMsg status, TimeStampMsg timeStamp, String roleId, String name,
	...
	public String toString() {
		return "RoleMsg [roleId=" + roleId + ", name=" + name + ", note=" + note + ", menuIds=" + menuIds + "]";
	}
	public RoleMsg() {
		super();
	}
