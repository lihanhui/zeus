...
public class SubmitApiMsg {
	...
	public SubmitApiMsg(UserIdMsg userId, String apiId, String apiName, Integer rwMode, String module) {
		super();
		this.userId = userId;
		this.apiId = apiId;
		this.apiName = apiName;
	...
	public String toString() {
		return "SubmitApiMsg [userId=" + userId + ", apiId=" + apiId + ", apiName=" + apiName + ", rwMode=" + rwMode
				+ ", module=" + module + "]";
	}
	public SubmitApiMsg() {
		super();
